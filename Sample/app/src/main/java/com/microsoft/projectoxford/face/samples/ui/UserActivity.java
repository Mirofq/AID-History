...
public class UserActivity extends AppCompatActivity {
    ...
    String userId;
    //Button resendCode;
    Button ClearBT, changeProfileImage;
    //FirebaseUser user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ClearBT = findViewById(R.id.ClearHistoryButton);
...
//
 ...
 //documentReference.get()
    ...
    public void LoadHistory() {
        ...
        DocumentReference db = fStore.collection("users").document(userId).collection("Result").document("ScoreData");
        ...
        db.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                ...
                if (documentSnapshot.exists()) {
                    ...
                    //final TextView txScore = new TextView(UserActivity.this);
                    ...
                    //ClearBT = (Button) findViewById(R.id.ClearHistoryButton);
    ...
    public void DeleteHistory(View v){
        ...
        DocumentReference documentReference = fStore.collection("users").document(userId).collection("Result").document("ScoreData");
