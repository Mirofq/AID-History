...
public class BreathingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        VideoView videoView = (VideoView) findViewById(R.id.videoBreathing);  //casting to VideoView is not Strictly required above API level 26
        ...
        Uri uri = Uri.parse("android.resource://com.example.android.depressiontest/" + R.raw.breathingvideo);
